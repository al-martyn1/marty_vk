...
MARTY_CPP_ENUM_FLAGS_SERIALIZE_BEGIN( KeyEventFlags, std::map, 1 )
    ...
    MARTY_CPP_ENUM_FLAGS_SERIALIZE_ITEM( KeyEventFlags::KeyUp              , "KeyUp"            );
...
MARTY_CPP_ENUM_FLAGS_DESERIALIZE_BEGIN( KeyEventFlags, std::map, 1 )
    ...
    MARTY_CPP_ENUM_FLAGS_DESERIALIZE_ITEM( KeyEventFlags::KeyUp              , "key-up"              );
    MARTY_CPP_ENUM_FLAGS_DESERIALIZE_ITEM( KeyEventFlags::KeyUp              , "key_up"              );
    MARTY_CPP_ENUM_FLAGS_DESERIALIZE_ITEM( KeyEventFlags::KeyUp              , "keyup"               );
